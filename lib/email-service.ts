        ...
        try {
          ...
          <div style="font-family: sans-serif; max-width: 600px; margin: auto;">
            ...
            <div style="margin: 30px 0;">
              <a href="${whatsappLink}" style="background: #25D366; color: white; padding: 12px 24px; border-radius: 6px; text-decoration: none; font-weight: bold; display: inline-block;">
                JOIN WHATSAPP GROUP
              </a>
            </div>
    ...
    for (const account of emailAccounts) {
        try {
          ...
          <div style="font-family: sans-serif; max-width: 600px; margin: auto; line-height: 1.6;">
            <p>Hello ${name},</p>
            <p>We are writing to inform you that your registration for TechSprint 2K26 has been <strong>rejected</strong> due to invalid details.</p>
            <p>If this was a mistake on our part, we sincerely apologize. Please feel free to re-register with the correct details.</p>
            <hr />
            <p style="font-size: 12px; color: #666;">This is an automated message. Please do not reply.</p>
          </div>
        `,
